...
def scene_reconstruction(dataset, opt, hyper, pipe, testing_iterations, saving_iterations, 
    ...
    if opt.dataloader:
        ...
        t_idxs = list(range(0, len(viewpoint_stack), scene.maxtime))
    ...
    for iteration in range(first_iter, final_iter+1):        
        ...
        for viewpoint_cam in viewpoint_cams:
            ...
            if scene.dataset_type!="PanopticSports":
                # TODO : path
                #image = Image.open(os.path.join(edited_images_path, "edited_photograph_render_time0_{:d}.png".format(dict_sear_steak[int(viewpoint_cam.image_name)])))
                image = Image.open(os.path.join(edited_images_path, "edited_photograph_render_time0_{:d}.png".format(int(viewpoint_cam.image_name)//scene.maxtime)))
